...
public class Main {
    ...
    // Inicializamos las clases que vamos a usar
    private static Scanner scanner = new Scanner(System.in);
    private static final Memoria memoria = new Memoria(); //Instanciamos la clase memoria y se la pasamos a los constructores para que todos actúen sobre la misma
    private static final ClienteService clienteService = new ClienteService(memoria);
    private static final CuentaService cuentaService = new CuentaService(memoria, clienteService);
    private static final OperacionService operacionService = new OperacionService(memoria, cuentaService);
